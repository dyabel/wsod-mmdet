...
class WSOD_RPNHead(RPNTestMixin, AnchorHead):
    """RPN head.
    ...
    def __init__(self, in_channels, **kwargs):
        super(WSOD_RPNHead, self).__init__(1, in_channels, **kwargs)
    ...
    def loss(self,
        ...
        """
        losses = super(WSOD_RPNHead, self).loss(
            # [cls_scores[0]],
            # [bbox_preds[0]],
            # [gt_bboxes[0]],
            # [cls_scores[0]],
    ...
    def forward_train(self,
        ...
        if gt_labels is None:
            loss_inputs = outs_strong + ([gt_bboxes[0]], [img_metas[0]])
        else:
            loss_inputs = outs_strong + ([gt_bboxes[0]], [gt_labels[0]], [img_metas[0]])
