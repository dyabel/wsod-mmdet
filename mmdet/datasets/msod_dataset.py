...
class MsodDataset(CustomDataset):
    ...
    def __init__(self,
        ...
        super(MsodDataset,self).__init__(ann_file,pipeline,classes=classes,data_root=data_root,
        ...
        if not test_mode:
            ...
            # self.valid_img_ids = [self.img_ids[i] for i in valid_inds]
            print(self.img_ids)
            ...
            for i in self.coco.catToImgs.keys():
                ...
                print(len(self.coco.catToImgs[i]))
